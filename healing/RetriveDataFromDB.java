...
public class RetriveDataFromDB {
	...
	private void fetchAllRecordsFromDB(String variableName, SeleniumTestParameters testParameters) {

		BasicDBObject query = new BasicDBObject();
		query.put("UniqueVariableName", variableName);
		Document document = collection.find(query).first();

		JSONObject entireLocatorsObject = new JSONObject(document.toJson());
		JSONObject browserObject = entireLocatorsObject.getJSONObject(testParameters.getBrowser().toString());
	...
	private void getLuckyLoctorsFromDB(JSONObject browserObject) {
	...
	private void getCoordinateLocatorsFromDB(JSONObject browserObject) {
	...
	private void getSiblingsLocatorsFromDB(JSONObject browserObject) {
	...
	private void getNeighbourLocatorsFromDB(JSONObject browserObject) {
	...
	private void getAlternateLocatorsFromDB(JSONObject browserObject) {
